          ...
          children: <Widget>[
            LayoutBuilder(
              builder: (context, constraints) {
                double stackWidth = constraints.maxWidth; // 获取 Stack 的实际宽度
                double knobRadius = 5.0; // 进度点半径
                double progressHeight = 4.0; // 进度条高度
                double leftPosition = (stackWidth - knobRadius * 2) * (position / duration); // 计算拖动点位置
                ...
                return Stack(
                  ...
                  children: [
                    ...
                    // 播放进度条
                    Container(
                      width: stackWidth * (position / duration),
                      height: progressHeight,
                      decoration: BoxDecoration(
                    ...
                    Positioned(
                      left:
                          widget.showPositioned ? leftPosition.clamp(0.0, stackWidth - knobRadius * 2) : 0.0, // 防止超出边界
                      top: (20.0 - knobRadius * 2) / 2,
                      child: CircleAvatar(
                        radius: widget.showPositioned ? knobRadius : 0.0,
